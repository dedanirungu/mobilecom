...
import {createSmsinTable, listRecord, timeConverter} from "../Helper"
...
function SMSIn(props) { 
  ...
  const [smsin_list, setSMSInList] = useState([]);
  ...
  return (
    ...
    <View style={styles.body}>
      ...
      <ScrollView>
          { !loading ? 
          <View>         
            <Text style = {styles.viewTitle}>SMSIn List</Text>
